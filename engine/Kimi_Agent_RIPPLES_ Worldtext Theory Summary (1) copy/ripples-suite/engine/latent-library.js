 ...
 * ======================
 * 
 * Pre-written poetic descriptions for all Entity × Vector combinations.
 * 
 * CONTEXT WINDOW: ~3000 tokens (all scenarios)
 * Load on-demand per scenario: ~800 tokens
 */
